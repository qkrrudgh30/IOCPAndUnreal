...
public:
    static void Init()
    {
        ...
        GPacketHandlerFunctions[PKT_S_LOGIN] = [](USPacketSessionSharedPtr& InPacketSession, BYTE* InBuffer, int32 InBufferLength) { return HandlePacket<Protocol::S_LOGIN>(Handle_S_LOGIN, InPacketSession, InBuffer, InBufferLength); };
        GPacketHandlerFunctions[PKT_S_ENTER_GAME] = [](USPacketSessionSharedPtr& InPacketSession, BYTE* InBuffer, int32 InBufferLength) { return HandlePacket<Protocol::S_ENTER_GAME>(Handle_S_ENTER_GAME, InPacketSession, InBuffer, InBufferLength); };
        GPacketHandlerFunctions[PKT_S_LEAVE_GAME] = [](USPacketSessionSharedPtr& InPacketSession, BYTE* InBuffer, int32 InBufferLength) { return HandlePacket<Protocol::S_LEAVE_GAME>(Handle_S_LEAVE_GAME, InPacketSession, InBuffer, InBufferLength); };
        GPacketHandlerFunctions[PKT_S_SPAWN] = [](USPacketSessionSharedPtr& InPacketSession, BYTE* InBuffer, int32 InBufferLength) { return HandlePacket<Protocol::S_SPAWN>(Handle_S_SPAWN, InPacketSession, InBuffer, InBufferLength); };
        GPacketHandlerFunctions[PKT_S_DESPAWN] = [](USPacketSessionSharedPtr& InPacketSession, BYTE* InBuffer, int32 InBufferLength) { return HandlePacket<Protocol::S_DESPAWN>(Handle_S_DESPAWN, InPacketSession, InBuffer, InBufferLength); };
        GPacketHandlerFunctions[PKT_S_MOVE] = [](USPacketSessionSharedPtr& InPacketSession, BYTE* InBuffer, int32 InBufferLength) { return HandlePacket<Protocol::S_MOVE>(Handle_S_MOVE, InPacketSession, InBuffer, InBufferLength); };
        GPacketHandlerFunctions[PKT_S_CHAT] = [](USPacketSessionSharedPtr& InPacketSession, BYTE* InBuffer, int32 InBufferLength) { return HandlePacket<Protocol::S_CHAT>(Handle_S_CHAT, InPacketSession, InBuffer, InBufferLength); };
    }
    ...
    static USSendBufferSharedPtr MakePacket(Protocol::C_LOGIN&InPacket) { return MakePacket(InPacket, PKT_C_LOGIN); }
    static USSendBufferSharedPtr MakePacket(Protocol::C_ENTER_GAME&InPacket) { return MakePacket(InPacket, PKT_C_ENTER_GAME); }
    static USSendBufferSharedPtr MakePacket(Protocol::C_LEAVE_GAME&InPacket) { return MakePacket(InPacket, PKT_C_LEAVE_GAME); }
    static USSendBufferSharedPtr MakePacket(Protocol::C_MOVE&InPacket) { return MakePacket(InPacket, PKT_C_MOVE); }
    static USSendBufferSharedPtr MakePacket(Protocol::C_CHAT&InPacket) { return MakePacket(InPacket, PKT_C_CHAT); }
